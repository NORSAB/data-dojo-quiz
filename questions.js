window.questionsData = [
        // 1. Single Choice (Technical)
        {
          "id": 1,
          "courseId": "demo",
          "lang": "en",
          "type": "single_choice",
          "prompt": "You are creating a semantic model in Fabric. Which T-SQL command is used to see the relationships?",
          "options": [ { "id": "a", "text": "SELECT * FROM Relations" }, { "id": "b", "text": "INFOview.RELATIONSHIPS" }, { "id": "c", "text": "DMV queries" }, { "id": "d", "text": "SHOW RELATIONSHIPS" } ],
          "correctIds": ["c"],
          "explanation": "Dynamic Management Views (DMVs) are often used to inspect internal metadata like relationships."
        },
        // 2. Single Choice (Spanish)
        {
          "id": 2,
          "courseId": "demo",
          "lang": "es",
          "type": "single_choice",
          "prompt": "¿Qué herramienta de Fabric se utiliza principalmente para la ingeniería de datos a escala de petabytes?",
          "options": [ { "id": "a", "text": "Data Factory" }, { "id": "b", "text": "Synapse Real-Time Analytics" }, { "id": "c", "text": "Synapse Data Engineering (Spark)" }, { "id": "d", "text": "Power BI" } ],
          "correctIds": ["c"],
          "explanation": "Synapse Data Engineering utiliza pools de Spark para procesar grandes volúmenes de datos."
        },
        // 3. Multiple Choice
        {
          "id": 3,
          ...
          "prompt": "Which of the following are valid table types in a Fabric Lakehouse?",
          "options": [ { "id": "a", "text": "Managed Tables" }, { "id": "b", "text": "External Tables" }, { "id": "c", "text": "Virtual Tables" }, { "id": "d", "text": "Temporary Tables" } ],
          "correctIds": ["a", "b"],
          "explanation": "Fabric Lakehouses support both Managed (Internal) and External tables."
        },
        // 4. Ordering (Drag and Drop)
        {
            ...
            "lang": "en",
            "type": "ordering",
            "prompt": "Order the steps of a typical MLflow lifecycle.",
            "options": [ { "id": "a", "text": "Log Model" }, { "id": "b", "text": "Start Run" }, { "id": "c", "text": "Register Model" }, { "id": "d", "text": "Transition Stage" } ],
            "correctIds": ["b", "a", "c", "d"],
            "explanation": "Start Run -> Log Model -> Register Model -> Transition Stage."
        },
        // 5. True/False
        {
            "id": 6,
            ...
            "lang": "es",
            "type": "true_false",
            "prompt": "En Python, las listas son inmutables.",
            "options": [ { "id": "true", "text": "Verdadero" }, { "id": "false", "text": "Falso" } ],
            "correctIds": ["false"],
            "explanation": "Falso. Las listas en Python son mutables. Las tuplas son inmutables."
        },
        // 6. Scenario Based
        {
            "id": 7,
            ...
            "lang": "en",
            "type": "scenario",
            "scenarioText": "A user is attempting to login to a web application but keeps receiving a 403 Forbidden error effectively blocking access.",
            "prompt": "Which of the following is the most likely cause?",
            "options": [
              { "id": "a", "text": "The server is down (500)" },
              { "id": "b", "text": "The user is authenticated but lacks permission" },
              { "id": "c", "text": "The user is not authenticated (401)" },
              { "id": "d", "text": "The resource does not exist (404)" }
            ],
            "correctIds": ["b"],
        ...
        // 7. Math / LaTeX
        {
            ...
            "lang": "en",
            "type": "single_choice",
            "prompt": "Calculate the limit: $$\\lim_{x \\to \\infty} \\frac{1}{x}$$",
            ...
            "correctIds": ["b"],
            "explanation": "As x grows arbitrarily large, 1/x approaches 0."
        },
    {
        id: "dp600-1",
        courseId: "dp-600",
