...
function renderReview(questions, finalPct, passed) {
  ...
  window.openStudyMode = function (courseId) {
    ...
    // ===================================================================
    if (courseId === "unir-viz-interactiva" || courseId === "unir-herramientas-viz" || courseId === "unah-tesis" || courseId === "databricks-da" || courseId === "databricks-fundamentals" || courseId === "dp-600") {
      const startScreen = document.getElementById("start-screen");
      ...
      const storageKey = courseId === 'unir-herramientas-viz' ? 'unir_herr_mastery' : (courseId === 'unah-tesis' ? 'unah_tesis_mastery' : (courseId === 'databricks-da' ? 'databricks_da_mastery' : (courseId === 'databricks-fundamentals' ? 'databricks_fund_mastery' : (courseId === 'dp-600' ? 'dp600_mastery' : 'unir_viz_mastery'))));
      ...
      const domainMasteryAchievements = (courseId === 'databricks-da') ? [
